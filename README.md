...
- UNVERIFIED — no pid recorded (an in-session agent or a stale entry): BACKLOG MERGE VERIFIER (Opus on A): the three doors, CONSENT-P0 and the claim trust fix, merged onto today's canonical at 4be4117850
