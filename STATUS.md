...
|---|---|---|
| **Claude A** | 50% of its week used | The one to spend. Routine work goes here. Refills Sep 25 at 7pm. |
...
- meters weekly: A **50%** · B **91%** · band: ≤55% → 2 builder(s)
...
[1m🎚 THE BAND (resource mode, 2026-09-16):[0m working account A at weekly 50% → [1m2 builder(s)[0m · two builders maximum; Opus only for genuinely hard work
