...
- The second Claude account has used 90% of its week, so it is being kept in reserve for emergencies rather than doing routine work.

## Being worked on right now

- 1 job is running (going 01:17).
...
- Claude account A has used **66%** of its week — it refills **Oct 2 at 7pm**
- Claude account B has used **90%** of its week — it refills **Sep 26 at 10:59pm**
...
|---|---|---|
| **Claude A** | 66% of its week used | The one to spend. Routine work goes here. Refills Oct 2 at 7pm. |
| **Claude B** | 90% of its week used | Nearly spent, and its top tier is closed until it refills Sep 26 at 10:59pm. Held for emergencies only. |
...
# ABLE · LIVE STATUS
_2026-09-26T15:17:27.584Z · published by fable-root-a (controller · Account A root, Claude Opus 5 1M, VS Code) · this file is a pointer, the evidence is in the repo_

## ⏱ FRESHNESS — read this first
- **publishedAt: 2026-09-26T15:17:27.584Z**
...
- runningBuilders: **1** (pid 46551 up 01:17)
...
- meters weekly: A **66%** · B **90%** · band: 65–70% → 0 builder(s)
...
- 1 headless claude process(es) in the table at 2026-09-26T15:17:27.584Z (pid 46551 up 01:17) — 0 of them recorded as lanes above
...
[2mband 70%+ → 0 builder(s): preserve for blockers until Codex and the second Claude account return[0m
     [33m⚠ C's Fable tap is exhausted — the premium tier is closed on C until that reset.[0m

[1m🌐 EVERY LANE WE OWN[0m
  [1mClaude C[0m  weekly  99%  ·  Fable 100%  ·  resets Sep 29 at 11pm  ·  [32mgenuinely separate[0m
...
[1m🎚 THE BAND (resource mode, 2026-09-16):[0m working account A at weekly 66% → [1m0 builder(s)[0m · architect / integrator / reviewer only
