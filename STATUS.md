# ABLE · LIVE STATUS
_2026-09-16T19:58:20.954Z · published by fable-root (Account A, Claude Fable 5.1) · this file is a pointer, the evidence is in the repo_
...
- candidateBranch: fold-bc-20260916 · candidateHead: 0b07d58071032a5049112f8af2e32c17e21b5af5
- lastVerifiedAt: 2026-09-16T19:58:19.793Z
...
- publicMirrorReadable: true (unauthenticated fetch of the raw mirror, 2026-09-16T19:58:24.941Z)
...
- fold-bc-20260916 @ 0b07d58071 — the Account B window preserved the Fable builder's staged commit-2 tree (no correctness claim); the Opus builder resumed on top (pid 90809) and is finishing commit 2 → then r2 on the candidate (five claims: 0 third-party requests undecided at 390/834/1440 · Enable mounts · one sound owner · per-kind section lists differ · 0 P0)
...
- Account B (OPUS — Fable on this account is spent; both builders hit the limit) · builder: the B+C RETURN commit 2 (the renderer obeys composeWork) resumed from its staged state in fold-bc-20260916
